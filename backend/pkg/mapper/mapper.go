...
import (
	...
	reflectionHelper "github.com/shishir54234/NewsScraper/backend/pkg/reflection/reflection_helper"
...
func CreateMap[TSrc any, TDst any]() error {
	...
	if (srcType.Kind() != reflect.Struct && 
		(srcType.Kind() == reflect.Ptr && srcType.Elem().Kind() != reflect.Struct)) || (desType.Kind() != reflect.Struct && (desType.Kind() == reflect.Ptr && desType.Elem().Kind() != reflect.Struct)) {
